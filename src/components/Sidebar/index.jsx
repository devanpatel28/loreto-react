                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark hover:text-white dark:hover:bg-meta-4 ${(pathname === '/forms' ||
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/institution-info"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark hover:text-white dark:hover:bg-meta-4 ${pathname.includes('institution-info') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <div className='flex w-[22px] justify-center'>
              ...
              <li>
                <NavLink
                  to="/qsetting"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark hover:text-white dark:hover:bg-meta-4 ${pathname.includes('qsetting') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <div className='flex w-[22px] justify-center'>
              ...
              <li>
                <NavLink
                  to="/logout"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 text-red-500 duration-300 ease-in-out hover:bg-graydark hover:text-white dark:hover:bg-meta-4 ${pathname.includes('logout') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <div className='flex w-[22px] justify-center'>
